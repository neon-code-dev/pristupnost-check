...
export default function ScanForm({ size = "large" }: { size?: "large" | "compact" }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-xl mx-auto">
      ...
      <button
        type="submit"
        className="mt-3 h-14 sm:h-16 w-full rounded-xl bg-indigo-700 text-white text-lg font-bold tracking-wide hover:bg-indigo-800 active:bg-indigo-900 transition-all shadow-lg shadow-indigo-700/25 hover:shadow-indigo-700/40 cursor-pointer"
      >
        Zkontrolovat zdarma
      </button>
